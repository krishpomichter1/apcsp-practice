...
print(selected_label + ": " + bit_text)  # inside the valid report
print("Even")  # or print("Odd"), after your parity test
print("Outside six-bit range")  # inside the invalid branch